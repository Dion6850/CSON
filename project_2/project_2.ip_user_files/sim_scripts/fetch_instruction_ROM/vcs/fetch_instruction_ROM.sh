...
#                script (type 'fetch_instruction_ROM.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fetch_instruction_ROM xil_defaultlib.glbl -o fetch_instruction_ROM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fetch_instruction_ROM_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/zhywyt/CSON/01_Test/01_Test.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key fetch_instruction_ROM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fetch_instruction_ROM_simv.daidir vcs_lib c.obj)
