...
#
# Script generated by Vivado on Wed May 22 16:34:53 CST 2024
...
#
# Usage        : ROMc.sh
#                ROMc.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ROMc.sh [-reset_run]
#                ROMc.sh [-reset_log]
#                ROMc.sh [-help]
#
...
# script info
echo -e "ROMc.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ROMc.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ROMc xil_defaultlib.ROMc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ROMc -key {Behavioral:sim_1:Functional:ROMc} -tclbatch cmd.tcl -log simulate.log -maxdeltaid 100000
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ROMc.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ROMc.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ROMc.sh [-help]\n\
Usage: ROMc.sh [-step]\n\
Usage: ROMc.sh [-lib_map_path]\n\
Usage: ROMc.sh [-reset_run]\n\
Usage: ROMc.sh [-reset_log]\n\
Usage: ROMc.sh [-keep_index]\n\
Usage: ROMc.sh [-noclean_files]\n\n\
