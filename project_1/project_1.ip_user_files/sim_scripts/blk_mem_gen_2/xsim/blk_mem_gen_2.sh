...
#
# Script generated by Vivado on Wed Jun 05 22:42:44 +0800 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_2 xil_defaultlib.blk_mem_gen_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_gen_2 -key {Behavioral:sim_1:Functional:blk_mem_gen_2} -tclbatch cmd.tcl -log simulate.log -maxdeltaid 100000
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/FPGA/Vivado/2023.1/data/xsim"
  fi
