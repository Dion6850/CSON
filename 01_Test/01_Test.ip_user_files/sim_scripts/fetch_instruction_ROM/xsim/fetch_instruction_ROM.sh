...
#
# Script generated by Vivado on Wed May 15 12:37:19 CST 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fetch_instruction_ROM.sh
...
#
# Usage        : fetch_instruction_ROM.sh
#                fetch_instruction_ROM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fetch_instruction_ROM.sh [-reset_run]
#                fetch_instruction_ROM.sh [-reset_log]
#                fetch_instruction_ROM.sh [-help]
#
...
# script info
echo -e "fetch_instruction_ROM.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fetch_instruction_ROM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fetch_instruction_ROM xil_defaultlib.fetch_instruction_ROM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fetch_instruction_ROM -key {Behavioral:sim_1:Functional:fetch_instruction_ROM} -tclbatch cmd.tcl -log simulate.log -maxdeltaid 100000
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/zhywyt/backup/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fetch_instruction_ROM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fetch_instruction_ROM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fetch_instruction_ROM.sh [-help]\n\
Usage: fetch_instruction_ROM.sh [-step]\n\
Usage: fetch_instruction_ROM.sh [-lib_map_path]\n\
Usage: fetch_instruction_ROM.sh [-reset_run]\n\
Usage: fetch_instruction_ROM.sh [-reset_log]\n\
Usage: fetch_instruction_ROM.sh [-keep_index]\n\
Usage: fetch_instruction_ROM.sh [-noclean_files]\n\n\
